...
The excursion start at 15.15 at [Oyfo Techniekmuseum, Hazemeijerstraat 300, Hengelo](http://www.oyfotechniekmuseum.nl). The organisers are going there by different means of transport, and are happy to take you along. We’ll keep you posted about where to gather at what time. The Banquet follows the excursion (it starts at 18.00) and takes place at: [Lust, Bakery en Bistro](https://lusthengelo.nl).

### Getting there
You can join (one of) your favourite organiser(s) going by your favourite means of transport. 

1) Join Rianne on foot: 7 kilometers (at 4.5-5 km/h), we leave at 13.45 at the main entrance of the UPark hotel.
...
#### Bet on Features: Anytime-Valid and Feature-Aware Auditing of Conditional Quantile Forecasters _(Ivane Antonov*, Sohom Mukherjee* (Speaker), Richard Pibernik, Yo Joong Choe)_
...
#### Interactive Edge Orientation Identification: An Optimization Approach _(Fabian Damken, Wouter M. Koolen, Rianne de Heide)_
...
#### E-Scores for (In)Correctness Assessment of Generative Model Outputs _(Guneet S. Dhillon, Javier González, Teodora Pandeva, Alicia Curth)_
...
#### Parameter-Free and Group Conditional Online Conformal Prediction _(Beepul Bharti, Ambar Pal, Jacopo Teneggi, Jeremias Sulam)_
...
#### Clinical trial problems looking for anytime-valid solutions _(Judith ter Schure)_
...
#### Incentive aware AI regulations: A credal characterisation _(Anurag Singh, Rajeev Verma, Julian Rodemann, Siu Lun Chau, Krikamol Muandet)_
...
#### e-values instead of p-values in clinical trials: What happens? _(Yongxi Long, Alexander ly, Jelle Goeman, Nikos Ignatiadis, Peter Grünwald, Erik van Zwet)_
...
#### Dynamic evidence synthesis with e-values: Anytime-valid meta-analysis for the presence or absence of effects _(Alexander Ly, Sebastian Arias, Sebastian Arnold, Udo Boehm, Stephan Bongers, Michele Meziu, Angel Reyero Lobo, Dante de Roos, Meike Steinhilber, Yongqi Wang, Peter Grünwald)_
...
#### Deliberative Prediction _(Rajeev Verma, Rabanus Derr, Christian A. Naesseth, Eric Nalisnick, Krikamol Muandet)_
...
#### Post-detection Inference for Sequential Changepoint Localization _(Aytijhya Saha, Aaditya Ramdas)_
